    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <View style={styles.card}>
                ...
                />
                <TouchableOpacity style={[ButtonStyles.primaryContainer, styles.cardButton]} onPress={handleUpdateProfile}>
                    <Text style={ButtonStyles.primaryText}>Mettre à jour le nom</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.card}>
                ...
                >
                    <Text style={ButtonStyles.primaryText}>Changer le mot de passe</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.card}>
                ...
                <TouchableOpacity
                    style={[ButtonStyles.primaryContainer, styles.cardButton, styles.deleteButton]}
                    onPress={handleDeleteAccount}
                >
                    <Text style={ButtonStyles.primaryText}>Supprimer mon compte</Text>
                </TouchableOpacity>
            </View>
        </ScrollView>
    );
