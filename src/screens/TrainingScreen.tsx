...
const TrainingScreen: React.FC = () => {
    ...
    const handleAction = (action: 'modifier' | 'supprimer') => {
        ...
        if (action === 'modifier') {
            navigation.navigate('AddEditExercise', { exercise: selectedExerciseAction }); // redirige vers l'écran de modif
        } else if (action === 'supprimer') {
            handleDeleteExercise(selectedExerciseAction); // lance la suppression
        }
    };
